                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="triggerId">
                        ...
                        ?>
                          ...
                          <a class="dropdown-item" href="<?= base_url('Pimpinan/mapel/'.$row->id_kelas.'/'.$idmapel) ?>"><?= $row->nama_mapel; ?></a>
                          ...
                          <tbody>
                            <?php
                                ...
                                foreach ($nilai as $row) :
                                  ...
                                  $nilaiTotal = round(($nilai->harian + $nilai->uts + $nilai->uas)/3,0);
                            ?> 
                              <tr>
                                <td><?= $no++; ?></td>
                                <td>
