                  ...
                  <div class="card-header">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="triggerId">
                        <a class="dropdown-item disabled" href="#">Pilih Kelas</a>
                        <?php
                          $data = $this->db->order_by('nama_mapel', 'ASC')
                                            ->where('guru_mapel', $iduser)
                        ...
                        ?>
                          ...
                          <a class="dropdown-item" href="<?= base_url('GuruMapel/nilai/'.$row->id_mapel) ?>"><?= $row->kelas.' ('.$row->nama_mapel.')'; ?></a>
                          
                        <?php endforeach; ?>
                      </div>
                    </div>
                  </div>
                  <form action="<?= base_url('GuruMapel/updateNilai/'.$id_kelas.'/'.$idmapel) ?>" method="post">
                        ...
                        <table class="table table-hover table-md" id="myTable">
                          ...
                          <tbody>
                            ...
                            ?> 
                              <tr>
                                <td><?= $no++; ?></td>
                                <td><input type="hidden" name="id[]" value="<?= $row->id; ?>"><?= $siswa->nama_siswa; ?></td>
                                <td width="90">
